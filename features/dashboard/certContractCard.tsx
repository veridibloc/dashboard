...
export function CertContractCard() {
  const router = useEnhancedRouter()
  const targetRoute = '/contracts?t=cert';
  return (
    <Link
      href={targetRoute}
      shallow={true}
    ...
    >
      ...
      <CardHeader>
        ...
        <CardDescription>
          View all cert contracts and their details.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="w-[256px] m-auto">
          <Image
            className="rounded"
            src="/assets/certcontract.webp"
            alt="Certification Contract Card"
            height={256}
            width={256}
          />
        </div>
